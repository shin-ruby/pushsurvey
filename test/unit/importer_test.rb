...
class ImporterTest < ActiveSupport::TestCase
  ...
  test "xlxs import should succeed" do
    assert_difference('Contact.count') do
      Importer.do_import(File.join(File.dirname(File.expand_path(__FILE__)),"proedmDB.xlsx"))
    end
  ...
  test "xls import should succeed" do
    assert_difference('Contact.count', 8) do
      Importer.do_import(File.join(File.dirname(File.expand_path(__FILE__)),"proedm.xls"))
    end
  ...
  test "csv import should succeed" do
    assert_difference('Contact.count', 8) do
      Importer.do_import(File.join(File.dirname(File.expand_path(__FILE__)),"proedmDB.csv"))
    end
